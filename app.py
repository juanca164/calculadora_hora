...
sueldo_base = st.number_input("Ingrese el sueldo base mensual", min_value=0)
Choras_extras = st.number_input("Cantidad de horas extras trabajadas", min_value=0.0)
horas_trabajadas_semana = st.number_input(" Cuántas horas trabaja a la semana", min_value=0)
